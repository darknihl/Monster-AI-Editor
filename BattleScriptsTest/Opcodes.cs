...
namespace BattleScriptsTest
{
    public enum SpellNumber : byte
    {
        ...
        Heartless_Angel = 0xC0, Barrier_Change = 0xC1, Flee = 0xC2, _50_Gs = 0xC3, Mind_Blast = 0xC4, Northern_Cross = 0xC5, Flare_Star = 0xC6, Overture = 0xC7, Grab = 0xC8, Reverse_Polarity = 0xC9,
